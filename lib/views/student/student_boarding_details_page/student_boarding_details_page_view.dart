...
import 'package:bordima/views/student/student_boarding_details_page/student_boarding_details_page_provider.dart';
...
import '../student_main_home_page/student_main_home_page_provider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Padding(
        padding: const EdgeInsets.all(20.0),
        child: isBook == (widget.board.status == 'booked' ? false : true)
            ? CustomMainButton(
                tap: () {
                  showDialog(
                    context: context,
